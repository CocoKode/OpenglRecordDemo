...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public static class RecordHandler extends Handler {
    	WeakReference<MediaVideoEncoder> mVideoEncoderReference;

    	public RecordHandler(MediaVideoEncoder encoder) {
    		mVideoEncoderReference = new WeakReference<MediaVideoEncoder>(encoder);
		}
		...
		public void handleMessage(Message msg) {
    		switch (msg.what) {
				case 0:
					MediaVideoEncoder encoder = mVideoEncoderReference.get();
					if (encoder != null) {
						encoder.isRecording = true;
						encoder.preDataFirst = true;
					}
					break;
				default:
					break;
